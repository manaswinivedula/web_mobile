...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.updateBook = function (id, data, prev_data) {
        var url = apiUrl + "/" + id;
        var combined_data = [];
        combined_data.push(data);
        combined_data.push(prev_data);
        console.log('combined_data', combined_data);
        return this.http.put(url, combined_data, httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    };
...
var BookEditComponent = /** @class */ (function () {
    ...
    BookEditComponent.prototype.onFormSubmit = function (form) {
        ...
        this.api.getBook(this.route.snapshot.params['id'])
            .subscribe(function (data) {
            _this.prev_data = data;
            // console.log('prev_data', this.prev_data);
            _this.api.updateBook(_this.route.snapshot.params['id'], form, _this.prev_data)
                .subscribe(function (res) {
...
module.exports = __webpack_require__(/*! C:\Users\manas\WebstormProjects\ICP-7\src\main.ts */"./src/main.ts");
